...
const NetworkStatsContext = createContext<any>({});

export const NetworkStatsProvider = (props: any) => {
    ...
    const fetchTotalTransactions = async () => {
        try {
            ...
            setTotalTransactions((prevTransactions: any) => {
    ...
    const updateTotalTransactions = (data: any) => {
